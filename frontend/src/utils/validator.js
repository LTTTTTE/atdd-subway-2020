const validator = {
  ...
  departureTime: {
    dayTime: [(v) => !!v || '오전 또는 오후를 골라 주세요.', (v) => (v === '오전' || v === '오후') || '오전 또는 오후를 골라 주세요.'],
    hour: [(v) => !!v || '시간을 입력해 주세요.', (v) => (v >= 0 && v < 24) || '정확한 시간을 입력해 주세요.'],
    minute: [(v) => !!v || '분을 입력해 주세요.', (v) => (v >= 0 && v <= 59) || '정확한 분을 입력해 주세요.']
  },
